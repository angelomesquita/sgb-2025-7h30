...
class BookAlreadyExistsError(BookError):
    """Raised when trying to register a book."""
    pass
...
class BookRestoreError(BookError):
    """Raised when trying to restore an active/new book"""
    pass
...
class BorrowAlreadyExistsError(BorrowError):
    """Raised when trying to register a borrow."""
    pass
...
class BorrowRestoreError(BorrowError):
    """Raised when trying to restore an active/new borrow"""
    pass
